...
- **次のステップ**:
  - **200語への拡張(v0.3相当)はユーザー判断で先送り**。次に何をやるかは未確定(pipe-v2基準測定 = 50語でtop-1 70%/top-5 90%を測る、ミラー拡張を本番モデルに反映するか、学習のシード固定に対応するか、など候補はあるが決定していない)
